...
export const UPDATED_AT = '2026-03-15T17:16:41.473Z'
export const STORAGE_KEY = 'r2-manager-config'
export const BUCKETS_KEY = 'r2-manager-buckets'
export const ACTIVE_BUCKET_KEY = 'r2-manager-active-bucket'
export const SIDEBAR_COLLAPSED_KEY = 'r2-manager-sidebar-collapsed'
...
export const MAX_UPLOAD_SIZE = 5 * 1024 * 1024 * 1024 // 5 GiB
