...
const I18N = {
  zh: {
    ...
    fileTooLarge: '文件 "{name}" 太大了（超过 {size}），试试 rclone 等工具吧',
  ...
  zh_TW: {
    ...
    fileTooLarge: '檔案「{name}」太大了（超過 {size}），試試 rclone 等工具吧',
  ...
  en: {
    ...
    fileTooLarge: '"{name}" is too large (over {size}) — try rclone for big uploads',
  ...
  ja: {
    ...
    fileTooLarge: '"{name}" は大きすぎます（{size}超）— rclone などをお試しください',
